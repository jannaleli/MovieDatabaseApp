...
public extension AlertType {
    ...
    ///   - handler: The block to execute after this action performed.
    /// - Returns: Myself
    func actions(_ actions: [Alertift.Action], handler: Handler? = nil) -> Self {
        actions.forEach { _ = action($0, handler: handler) }
        return self
    }

    func actions(_ actions: [String?], handler: Handler? = nil) -> Self {
    ...
    /// - Returns: Myself
    func finally(_ handler: Handler) -> Self {
    ...
    /// - Parameter color: UIColor
    /// - Returns: Myself
    func buttonTextColor(_ color: UIColor?) -> Self {
    ...
    /// - Parameter color: UIColor
    /// - Returns: Myself
    func messageTextColor(_ color: UIColor?) -> Self {
    ...
    /// - Returns: Myself
    func titleTextAlignment(_ alignment: NSTextAlignment) -> Self {
    ...
    /// - Parameter alignment: NSTextAlignment
    /// - Returns: Myself
    func messageTextAlignment(_ alignment: NSTextAlignment) -> Self {
    ...
    func show(on viewController: UIViewController? = UIApplication.shared.keyWindow?.rootViewController, completion: (() -> Void)? = nil) {
    ...
    internal func buildAlertAction(_ action: Alertift.Action, handler: Alertift.Action.Handler?) -> UIAlertAction {
